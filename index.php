...
<body>
    <div class="welcome-con" id="welcome-main">
        <header>
            <div class="logo-con">
                <img class="logo" src="images/amt-logo.png" alt="Logo"  loading="lazy">
                <div class="hamburger">
                    <div class="line"></div>
                    <div class="line"></div>
                    <div class="line"></div>
        ...
        <section class="welcome-main">
            ...
            <div class="img-container">
                <img id="particles" src="images/welcome-particles.png" alt=""  loading="lazy">
                <div class="person-main-img">
                    <img id="person" src="images/welcome-person-img.png" alt="woman"  loading="lazy">
                </div>
    ...
    <section class="about-us-con" id="about-us-con">
        <div class="about-video-con"  loading="lazy">
    ...
    <section class="slideshow-container" id="slideshow-container">
        ...
        <div class="mySlides fade">
            <div class="theme-con">
                <div class="img-con">
                    <img src="images/theme-1.png" alt="Theme 1"  loading="lazy">
                </div>
                <div class="theme-desc-con">
                    <h1 class="theme-heading">Blissful Bites</h1>
        ...
        <div class="mySlides fade">
            <div class="theme-con">
                <div class="img-con">
                    <img src="images/theme-2.png" alt="Theme 2"  loading="lazy">
                </div>
                <div class="theme-desc-con">
                    <h1 class="theme-heading">Brushwork Boulevard</h1>
                    ...
                    <p class="theme-content">This website template is suitable for businesses, stores, or shops that are related to art
                        ...
                        photo studios, art galleries, clothing lines and museums.
                    </p>
                    <div class="btn-container ">
        ...
        <div class="mySlides fade">
            <div class="theme-con">
                <div class="img-con">
                    <img src="images/theme-3.png" alt="Theme 3"  loading="lazy">
                </div>
                <div class="theme-desc-con">
                    <h1 class="theme-heading">Feast Factory</h1>
        ...
        <div class="mySlides fade">
            <div class="theme-con">
                <div class="img-con">
                    <img src="images/theme-4.png" alt="Theme 4"  loading="lazy">
                </div>
                <div class="theme-desc-con">
                    <h1 class="theme-heading">Step Central</h1>
        ...
        <div class="mySlides fade">
            <div class="theme-con">
                <div class="img-con">
                    <img src="images/theme-5.png" alt="Theme 5"  loading="lazy">
                </div>
                <div class="theme-desc-con">
                    <h1 class="theme-heading">Slice Street</h1>
        ...
        <div class="mySlides fade">
            <div class="theme-con">
                <div class="img-con">
                    <img src="images/theme-6.png" alt="Theme 6"  loading="lazy">
                </div>
                <div class="theme-desc-con">
                    <h1 class="theme-heading">Beauty Emporium</h1>
        ...
        <div class="mySlides fade">
            <div class="theme-con">
                <div class="img-con">
                    <img src="images/theme-8.png" alt="Theme 8"  loading="lazy">
                </div>
                <div class="theme-desc-con">
                    <h1 class="theme-heading">Tech Topia</h1>
        ...
        <div class="benefits-con">
            <div class="benefit">
                <div class="benefit-img-con benefit-img-con-1">
                    <img src="images/benefit1.png" alt=""  loading="lazy">
                </div>
            ...
            <div class="benefit">
                <div class="benefit-img-con benefit-img-con-2">
                    <img src="images/benefit2.png" alt=""  loading="lazy">
                </div>
            ...
            <div class="benefit">
                <div class="benefit-img-con benefit-img-con-3">
                    <img src="images/benefit3.png" alt=""  loading="lazy">
                </div>
            ...
            <div class="benefit">
                <div class="benefit-img-con benefit-img-con-4">
                    <img src="images/benefit4.png" alt=""  loading="lazy">
                </div>
            ...
            <div class="benefit">
                <div class="benefit-img-con benefit-img-con-5">
                    <img src="images/benefit5.png" alt=""  loading="lazy">
                </div>
            ...
            <div class="benefit">
                <div class="benefit-img-con benefit-img-con-6">
                    <img src="images/benefit6.png" alt=""  loading="lazy">
                </div>
            ...
            <div class="benefit">
                <div class="benefit-img-con benefit-img-con-7">
                    <img src="images/benefit7.png" alt=""  loading="lazy">
                </div>
    ...
    <section class="email-us-con" id="email-us-con">
        <div class="main-img-con">
            <div class="email-icon-img">
                <img src="images/talk-to-us-mail.png" alt=""  loading="lazy">
            </div>
            <div class="email-person-img">
                <img src="images/talk-to-us-person.png" alt="  loading="lazy"">
            </div>
    ...
    <section class="teams" id="teams">
        ...
        <div class="team-container">
            <div class="team-set-1">
                <div class="team">
                    <img src="images/team-1.png" alt="Team Member"  loading="lazy">
                    <p class="name">Dhan</p>
                    <p class="role">Front end Developer</p>
                </div>

                <div class="team">
                    <img src="images/team-2.png" alt="Team Member"  loading="lazy">
                    <p class="name">JP</p>
            ...
            <div class="team-set-2">
                <div class="team">
                    <img src="images/team-3.png" alt="Team Member"  loading="lazy">
                    <p class="name">Drev</p>
                    <p class="role">Back end Developer</p>
                </div>

                <div class="team">
                    <img src="images/team-4.png" alt="Team Member"  loading="lazy">
                    <p class="name">Ana</p>
    ...
    <section class="services-main-con" id="services">
        <div class="container">
            <div class="panel active" style="background-image: url(images/service-1-bg.jpg);"  loading="lazy">
                <img class="service-icon" src="images/service-1-icon.png" alt=""  loading="lazy">
                <h3 class="service-1-h3">Web Development</h3>
            </div>

            <div class="panel active" style="background-image: url(images/service-2-bg.jpg);"  loading="lazy">
                <img class="service-icon" src="images/service-2-icon.png" alt=""  loading="lazy">
                <h3 class="service-1-h3">Web Maintainance</h3>
            </div>

            <div class="panel active" style="background-image: url(images/service-3-bg.jpg);"  loading="lazy">
                <img class="service-icon" src="images/service-3-icon.png" alt=""  loading="lazy">
    ...
    <section class="our-plans-pricing-con" id="our-plans-pricing-con">
        ...
        <div class="plans">
            <div class="plan plan-1">
                <img src="images/basic.png" alt=""  loading="lazy">
                <h3>Basic</h3>
            ...
            <div class="plan plan-2">
                <img src="images/pro.png" alt=""  loading="lazy">
                <h3>Pro</h3>
                <div class="include-con"><i class="fa-solid fa-check"></i>
                    <p class="include">Choose your own website name</p>
                </div>
            ...
            <div class="plan plan-3">
                <img src="images/business.png" alt=""  loading="lazy">
                <h3>Business</h3>
                <div class="include-con"><i class="fa-solid fa-check"></i>
                    <p class="include">Choose your own website name</p>
                </div>
    ...
    <div class="footer">
        ...
        <div class="contact-us-con">
            ...
            <div class="contact-us">
                <div class="img-con">
                    <img src="images/email.png" alt=""  loading="lazy">
                </div>
                <div class="email-us">
                    <h3>Email Us:</h3>
            ...
            <div class="contact-us">
                <div class="img-con">
                    <img src="images/social-links.png" alt=""  loading="lazy">
                </div>
                <div class="location-desc">
                    <h3>Visit Us:</h3>
